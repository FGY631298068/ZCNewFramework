...
#import "YCSDWebImagePrefetcher.h"

#if (!defined(DEBUG) && !defined (SD_VERBOSE)) || defined(SD_LOG_NONE)
#define NSLog(...)
#endif

@interface YCSDWebImagePrefetcher ()

@property (strong, nonatomic) YCSDWebImageManager *manager;
@property (strong, nonatomic) NSArray *prefetchURLs;
@property (assign, nonatomic) NSUInteger requestedCount;
@property (assign, nonatomic) NSUInteger skippedCount;
@property (assign, nonatomic) NSUInteger finishedCount;
@property (assign, nonatomic) NSTimeInterval startedTime;
@property (copy, nonatomic) YCSDWebImagePrefetcherCompletionBlock completionBlock;
@property (copy, nonatomic) YCSDWebImagePrefetcherProgressBlock progressBlock;

@end

@implementation YCSDWebImagePrefetcher
...
- (id)init {
    if ((self = [super init])) {
        _manager = [YCSDWebImageManager new];
        _options = YCSDWebImageLowPriority;
...
- (void)startPrefetchingAtIndex:(NSUInteger)index {
    ...
    self.requestedCount++;
    [self.manager downloadImageWithURL:self.prefetchURLs[index] options:self.options progress:nil completed:^(UIImage *image, NSError *error, YCSDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
        if (!finished) return;
        self.finishedCount++;
