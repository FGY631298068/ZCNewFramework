...
@implementation UIScrollView (YCMJRefresh)

#pragma mark - header
static const char MJRefreshHeaderKey = '\0';

- (void)setMj_header:(YCMJRefreshHeader *)mj_header
{
...
- (void)setMj_footer:(YCMJRefreshFooter *)mj_footer
{
...
- (YCMJRefreshFooter *)mj_footer
{
    return objc_getAssociatedObject(self, &MJRefreshFooterKey);
}

#pragma mark - 过期
- (void)setFooter:(YCMJRefreshFooter *)footer
{
    self.mj_footer = footer;
}

- (YCMJRefreshFooter *)footer
{
    return self.mj_footer;
}

- (void)setHeader:(YCMJRefreshHeader *)header
{
    self.mj_header = header;
}

- (YCMJRefreshHeader *)header
{
